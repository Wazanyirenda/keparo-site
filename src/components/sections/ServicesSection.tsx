      ...
      <div className="flex-col max-w-screen-xl items-center gap-12 sm:gap-16 md:gap-20 bg-white flex w-full">
        <div className="flex-col max-w-screen-md items-center gap-6 sm:gap-8 w-full flex">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 w-full sm:w-auto">
            <Button
              variant="outline"
              className="h-auto inline-flex items-center justify-center gap-2 px-6 py-2.5 mt-[-1.00px] mb-[-1.00px] ml-[-1.00px] rounded-xl border border-solid border-[#04070926] bg-transparent hover:bg-transparent w-full sm:w-auto"
            >
